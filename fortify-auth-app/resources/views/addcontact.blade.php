                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card mb-4">
                            ...
                            <h5 class="card-header-text">Add Contact</h5>
                            </div>
                            

                            <div class="card-body">
                                <form action="{{ route('contact.store') }}" method="POST" id="crud-form" class="m-2" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                    <!-- First Name Field -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6 input-group">
                                            ...
                                            <input type="tel" class="form-control" id="contact" name="contact" placeholder="Enter Primary Contact">
                                        ...
                                        <div class="mb-3 col-lg-6 input-group">
                                            <span class="input-group-addon"><i class="icofont icofont-phone"></i></span>
                                            <input type="tel" class="form-control" id="secondary_contact" name="secondary_contact" placeholder="Enter Secondary Contact">
